...
@class NSArray, NSDictionary, NSSet, NSString, NSURL, XRPackagedInstrument;

@interface XRPackagedInstrumentTypeData : NSObject <XRInstrumentTypeData>
{
...
- (id)initWithPackagedInstrument:(id)arg1;
