...
@class NSEvent, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSPredicate, NSString, PFTCallTreeNode, PFTPersistentSymbols, XRDevice, XRTrace;
