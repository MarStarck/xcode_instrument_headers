...
@class NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, XRArchitecture, XRCodeManager;
...
@interface PFTPersistentSymbols : NSObject <NSCoding, XRCodeProvider>
{
    ...
    NSObject<OS_dispatch_queue> *_threadNamingQueue;
...
- (id)initWithSymbolicator:(struct _CSTypeRef)arg1 kernelSymbolicator:(struct _CSTypeRef)arg2 pid:(int)arg3 name:(id)arg4;
