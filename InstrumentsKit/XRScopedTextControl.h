...
@class DVTSourceTextScrollView, NSBox, NSButton, NSImageView, NSProgressIndicator, NSSegmentedControl, NSSplitView, NSString, NSTextField, NSView, XRFlagsNavigatorControl, XRTextView;
