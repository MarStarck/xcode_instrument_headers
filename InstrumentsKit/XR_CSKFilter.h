...
@interface XR_CSKFilter : NSObject <NSCopying, NSSecureCoding, NSPasteboardWriting, NSPasteboardReading>
{
    BOOL _isWildcard;
    BOOL _invert;
    long long _type;
...
- (id)initWithType:(long long)arg1 comparisonType:(long long)arg2 value:(id)arg3 invert:(BOOL)arg4;
