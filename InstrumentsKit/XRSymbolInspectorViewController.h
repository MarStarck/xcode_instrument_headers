...
@class DVTBorderedView, DVTScopeBarButton, DVTSearchField, NSButton, NSMenuItem, NSMutableArray, NSMutableSet, NSProgressIndicator, NSSet, NSString, NSTextField, NSView, XRProcessAndSymbolOwnerListModel, XRSymbolInspectorCustomOutlineView, XRSymbolOwnerListLimiter;
