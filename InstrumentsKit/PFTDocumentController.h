...
@class NSMenu, NSURL, NSWindow, XRDockMenuViewController, XRFlagViewer, XRInstrumentMenuController, XRTemplateChooserWindowController;
...
@interface PFTDocumentController : NSDocumentController
{
    ...
    XRTemplateChooserWindowController *_importTemplateChooser;
    NSURL *_importURL;
}
...
- (id)importTraceWithContentsOfURL:(id)arg1 template:(id)arg2 error:(id *)arg3;
- (BOOL)canImportTrace:(id)arg1;
...
- (id)_waitForPairedDeviceWithIdentifier:(id)arg1;
...
- (BOOL)showImportTemplateChooser;
