...
@class DVTBorderedView, DVTScopeBarButton, DVTSearchField, NSButton, NSCollectionView, NSDictionary, NSImageView, NSMutableArray, NSScrollView, NSString, NSTextField, NSTextFieldCell, NSView, XRRecentArrayStoredPrefs, XRTargetChooserPathControl, XRTemplateChooserTargetedObject, XRTemplateCollectionViewItem, XRTemplateItemView;
...
@interface XRTemplateChooserWindowController : NSWindowController <XRDeviceObserver, NSPathControlDelegate, NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate, NSWindowDelegate, NSCollectionViewDelegate>
{
    ...
    NSTextFieldCell *_textProfilingTemplate;
...
@property NSTextFieldCell *textProfilingTemplate; // @synthesize textProfilingTemplate=_textProfilingTemplate;
