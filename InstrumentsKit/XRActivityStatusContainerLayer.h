...
@class NSArray, NSMapTable, NSMutableArray, NSString, XRActivityStatusContainerLabelLayer;

@interface XRActivityStatusContainerLayer : CALayer
{
    CDUnknownBlockType _statusCategoryClickHandler;
    XRActivityStatusContainerLabelLayer *_labelLayer;
