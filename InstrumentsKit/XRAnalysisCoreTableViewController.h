...
@class NSArray, NSDictionary, NSIndexSet, NSString, NSTableView, XRActionContext, XRAnalysisCoreFullTextSearchSpec, XRAnalysisCoreTableViewColumnList, XRAnalysisCoreTableViewContent, XRAnalysisCoreTableViewControllerProvider, XRAnalysisCoreTableViewFindContext, XRDetailViewSplashViewController, XRInstrumentControlState;

@interface XRAnalysisCoreTableViewController : NSViewController <NSTableViewDelegate, NSTableViewDataSource, NSMenuDelegate, DTRenderableContentProviderDelegate, XRFilteredDataSource, XRSearchTarget>
{
    BOOL _responseStale;
    ...
    NSDictionary *_stateToRestoreAfterResponse;
    ...
    XRAnalysisCoreTableViewFindContext *_activeFindContext;
    struct XRTimeRange _focusedTimeRange;
}

@property(retain, nonatomic) XRAnalysisCoreTableViewFindContext *activeFindContext; // @synthesize activeFindContext=_activeFindContext;
...
- (void)_populateRowActionsMenu:(id)arg1;
...
- (void)_restoreUIState:(id)arg1 content:(id)arg2;
