...
#import "XR_CSKTokenFieldDelegate.h"

@class NSMutableArray, NSString, XR_CSKFilterGroup, XR_CSKToken, XR_CSKTokenField;

@interface XR_CSKTokenFieldController : NSObject <XR_CSKTokenFieldDelegate>
{
    int _mostRecentUserSelectedGlobalOperatorType;
    BOOL _isBasicSearchEnabled;
    XR_CSKTokenField *_tokenField;
    id <XR_CSKTokenFieldControllerDelegate> _delegate;
    NSMutableArray *_currentTokens;
    XR_CSKToken *_temporaryToken;
    NSString *_currentTerm;
    unsigned long long _lastChangeID;
}

+ (BOOL)_isTokenEligible:(id)arg1;
@property(nonatomic) unsigned long long lastChangeID; // @synthesize lastChangeID=_lastChangeID;
@property(retain, nonatomic) NSString *currentTerm; // @synthesize currentTerm=_currentTerm;
@property(retain, nonatomic) XR_CSKToken *temporaryToken; // @synthesize temporaryToken=_temporaryToken;
...
@property(nonatomic) __weak id <XR_CSKTokenFieldControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(nonatomic) int globalOperatorType;
...
@property(readonly, copy, nonatomic) XR_CSKFilterGroup *filterGroup;
- (void)dealloc;
- (id)init;
