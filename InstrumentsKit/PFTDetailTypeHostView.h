...
@class NSMapTable, NSString, NSTextField, PFTSelectedInstrumentList, XRAnalysisCoreDetailViewController, XRSearchBarViewController;
...
@interface PFTDetailTypeHostView : NSView <NSTokenFieldDelegate>
{
    ...
    XRAnalysisCoreDetailViewController *_controller;
...
- (void)updateInstrument:(id)arg1 withDetailView:(id)arg2 controller:(id)arg3;
